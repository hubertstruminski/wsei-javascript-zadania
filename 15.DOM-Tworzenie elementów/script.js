...
checkIfStringHasNumbers('Hu2ber5t');
...
const object2 = checkAlaExist('Hubert and Ala are students');
...
const lengthsOfStringArray = processStringArray(['Hubert', 'Jacek', 'Kuba', 'Kamil']);
...
assignAndProcessValuesToObject('Hubert', 'Strumiński', '24', baseObject);
